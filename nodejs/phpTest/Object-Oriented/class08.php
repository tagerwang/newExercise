...
class BaseClass {
    public $names="Jordan";// 定义属性
    const tconst ='tconst123';//const
    const tconstmmm ='tconstmmm';//const
    public  static $parentTest = "parentTest";//static属性；
       public static function parentFunc() {
       echo "parentFunc::test() called\n";
   }
...
class ChildClass extends BaseClass {
    public $names="Jordan";// 定义属性
    const tconst1 ='tconst1';//const
    public $parentTest1 = "parentTest1";//static属性；
  public $height="198cm";
  private static $sValue = "static value";
  const CONST_VALUE = 'A constant value';
  
  public function par(){
    echo $this->parentTest1;
    //echo $this->tconst;
      echo self::$sValue;
      //echo self::$parentTest;
      echo parent::$parentTest;
      echo $this->parentFunc();
  }
    public function test() {
        //echo parent::parentTest;
       echo "BaseClass::test() called\n";
          ...
          public static function parentFunc() {
       echo "childFunc_THIS::test() called\n";
   }
  public function moreTesting() {
